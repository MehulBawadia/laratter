...
class RegistrationTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->getRoute = route('user.register');
        $this->postRoute = route('user.register.store');
    }

    /** @test */
    public function guest_sees_registration_page()
    {
    ...
    /** @test */
    public function guest_is_logged_in_after_becoming_a_registered_user()
    {
    ...
    /** @test */
    public function shoots_mail_to_the_given_email_address_upon_registering()
    {
        Mail::fake();
    ...
    {
        factory(User::class)->create(['username' => 'johnny']);

        $this->post($this->postRoute, $this->mergeData(['username' => 'johnny']))
    ...
    {
        factory(User::class)->create(['email' => 'johnny@example.com']);

        $this->post($this->postRoute, $this->mergeData(['email' => 'johnny@example.com']))
