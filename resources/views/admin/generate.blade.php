        ...
        <div class="container mx-auto">
            ...
            <div class="mx-auto max-w-3xl bg-white rounded shadow-md overflow-hidden">
                <div class="bg-blue-200 px-3 py-2">
                    <h1 class="text-gray-900 uppercase font-bold text-2xl tracking-wider">Generate Administrator</h1>
                </div>
                <div class="bg white px-3 py-2">
                    <p class="text-sm text-gray-800">We will send an E-Mail containing the details you will give below.</p>

                    <form action="{{ route('admin.generate.store') }}" method="POST" id="formGenerateAdministrator">
                        @csrf
                        ...
                        <div class="flex justify-center items-center my-8">
                            <button type="submit" class="formSubmitBtn btnGenerateAdministrator">Generate</button>
                        </div>
                    </form>
                </div>
            </div>
...
@section('pageScripts')
    <script>
        $('.btnGenerateAdministrator').click(function (e) {
            ...
            var self = $(this),
                form = $('#formGenerateAdministrator');
