...
@section('content')
    ...
    <section class="px-3 py-5">
        <div class="container mx-auto">
            ...
            <div class="mx-auto mt-8 max-w-3xl bg-white rounded shadow-md overflow-hidden">
                <div class="bg-blue-200 px-3 py-2">
                    <h1 class="text-gray-900 uppercase font-bold text-2xl tracking-wider">Change Password</h1>
                </div>
                <div class="bg white px-3 py-2">
                    <form action="{{ route('admin.accountSettings.changePassword') }}" method="POST" id="formChangePassword">
                        @csrf
                        @method('PATCH')

                        <div class="flex flex-wrap items-center my-5">
                            <div class="w-full sm:w-1/5">
                                <label for="current_password" class="formLabel">Current Password:</label>
                            </div>
                            <div class="w-full sm:w-3/4">
                                <input type="password" name="current_password" id="current_password" class="formInput" required />
                        ...
                        <div class="flex flex-wrap items-center my-5">
                            <div class="w-full sm:w-1/5">
                                <label for="new_password" class="formLabel">New Password:</label>
                            </div>
                            <div class="w-full sm:w-3/4">
                                <input type="password" name="new_password" id="new_password" class="formInput" required />
                        ...
                        <div class="flex flex-wrap items-center my-5">
                            <div class="w-full sm:w-1/5">
                                <label for="repeat_new_password" class="formLabel">Repeat New Password:</label>
                            </div>
                            <div class="w-full sm:w-3/4">
                                <input type="password" name="repeat_new_password" id="repeat_new_password" class="formInput" required />
                                <span data-name="repeat_new_password"></span>
                            </div>
                        </div>

                        <div class="flex justify-center items-center my-8">
                            <button type="submit" class="formSubmitBtn btnChangePassword">Update</button>
                        </div>
                    </form>
                </div>
            </div>
