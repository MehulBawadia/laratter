        ...
        <div class="container mx-auto">
            ...
            <div class="mx-auto max-w-3xl bg-white rounded shadow-md overflow-hidden">
                <div class="bg-blue-200 px-3 py-2">
                    <h1 class="text-gray-900 uppercase font-bold text-2xl tracking-wider">Login Administrator</h1>
                </div>
                <div class="bg white px-3 py-2">
                    <form action="{{ route('admin.login.check') }}" method="POST" id="formLoginAdministrator">
                        @csrf
                        ...
                        <div class="flex justify-center items-center my-8">
                            <button type="submit" class="formSubmitBtn btnLoginAdministrator">Login</button>
                        </div>
                    </form>
                </div>
            </div>
