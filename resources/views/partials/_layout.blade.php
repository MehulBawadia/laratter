        ...
        <header class="bg-gray-900 px-3 py-1">
            <div class="container mx-auto">
                <div class="flex flex-wrap justify-between">
                    <div>
                        <div class="w-16">
                            <a href="{{ route('user.dashboard') }}"><img src="{{ asset('/images/laratter-logo.svg') }}" alt="{{ config('app.name') }}" title="{{ config('app.name') }}" loading="lazy" /></a>
                        </div>
                    </div>
                    <div class="flex items-center">
                        <x-admin-nav-link route="user.dashboard">Dashboard</x-admin-nav-link>
                        <x-admin-nav-link route="user.logout">Logout</x-admin-nav-link>
                    </div>
                </div>
            </div>
        </header>
